                ...
                <div className="flex justify-around">
                    <div className="flex flex-col gap-y-5">
                        <div className="carti">
                            ...
                            <h4 className="carti-title">— 01 dars</h4>
                            <h2 className="carti-subtitle">Storytelling nima?</h2>
                        ...
                        <div className="carti">
                            ...
                            <h4 className="carti-title">— 03 dars</h4>
                            <h2 className="carti-subtitle">Mavzu topish va tadqiq qilish</h2>
                            <p className="lessom-text mb-5">— Tinglovchi va tomoshabinning qiziqishini
                                saqlab qolish uchun qanday usullardan
                                foydalanamiz?</p>
                            <p className="carti-text mb-5">— Tomoshabinlarning e'tiborini mavzuga jalb
                                qilish va uni doimo faol tarzda ushlab turish
                                uchun nima qilish zarur?</p>
                            <p className="carti-text">— Qanday qilib biz kutilmagan burilishlar, aql
                        ...
                        <div className="carti">
                            ...
                            <h4 className="carti-title">— 05 dars</h4>
                            <h2 className="carti-subtitle">Kamera qarshisida ishlash</h2>
                            ...
                            <p className="carti-text">— Matnlarni yodlash kerakmi yoki oʻqishmi?
                        ...
                        <div className="carti">
                            ...
                            <h4 className="carti-title">— 07 dars</h4>
                            <h2 className="carti-subtitle">Studiya sharoitida ishlash</h2>
                            ...
                            <p className="carti-text">— Tayyorgarlik jarayoni tugagach, birgalikda
                                namuna tarzida koʻrsatuvni tasvirga tushiramiz.</p>
                        </div>

                        <div className="flex gap-x-5">
                            <button className="bg-[#FAA40C] py-[14px] px-[25px] text-black w-fit flex items-center gap-x-1">Guruhga qo’shilish</button>
                    ...
                    <div className="flex flex-col gap-y-5">
                        <div className="carti">
                            ...
                            <h4 className="carti-title">— 02 dars</h4>
                            <h2 className="carti-subtitle">Kopirayterlik va hikoya jozibasi</h2>
                        ...
                        <div className="carti">
                            ...
                            <h4 className="carti-title">— 04 dars</h4>
                            <h2 className="carti-subtitle">Nutq va gapirish usullari</h2>
                        ...
                        <div className="carti">
                            ...
                            <h4 className="carti-title">— 06 dars</h4>
                            <h2 className="carti-subtitle">Tasvirga olish vositalari va vizual
                                kompozitsiya</h2>
                        ...
                        <div className="carti">
                            ...
                            <h4 className="carti-title">— 08 dars</h4>
                            <h2 className="carti-subtitle">Montaj asoslari va uning tartibi</h2>
